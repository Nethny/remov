...
// HubOrder is an auto generated low-level Go binding around an user-defined struct.
...
// GetMOVROrders is a free data retrieval call binding the contract method 0xabdfa145.
//
// Solidity: function getMOVROrders() view returns((string,string)[])
func (_Hub *HubCaller) GetMOVROrders(opts *bind.CallOpts) ([]HubOrder, error) {
	var out []interface{}
	err := _Hub.contract.Call(opts, &out, "getMOVROrders")

	if err != nil {
		return *new([]HubOrder), err
	}

	out0 := *abi.ConvertType(out[0], new([]HubOrder)).(*[]HubOrder)
...
//
// Solidity: function getMOVROrders() view returns((string,string)[])
func (_Hub *HubSession) GetMOVROrders() ([]HubOrder, error) {
	return _Hub.Contract.GetMOVROrders(&_Hub.CallOpts)
}

// GetMOVROrders is a free data retrieval call binding the contract method 0xabdfa145.
//
// Solidity: function getMOVROrders() view returns((string,string)[])
func (_Hub *HubCallerSession) GetMOVROrders() ([]HubOrder, error) {
	return _Hub.Contract.GetMOVROrders(&_Hub.CallOpts)
}
...
//
// Solidity: function fillMOVROrders() returns()
...
//
// Solidity: function fillRMRKOrder(address Client, string UID, string URI, string data) returns()
